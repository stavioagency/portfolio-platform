...
export const RESERVED_SLUGS = new Set([
  ...
  // the two halves of the coming admin split, and the word a signed-in user's
  // own page would live at. Reserved BEFORE the routes exist: the shadowing
  // runs the wrong way round otherwise — a customer who claims `studio` today
  // is the one who breaks the day /studio ships, and by then the only fixes
  // are taking their address away or abandoning the route.
  'studio', 'console', 'me',
