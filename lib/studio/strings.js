...
export const STUDIO_STRINGS = {
  en: {
    ...
    copy: 'copy',
    copied: 'copied',
    // ── first run — blueprint §5.4 ──────────────────────────────────
    // The most important screen in the product. ONE question, three steps,
    // nothing else on the page. Never "complete your profile": that turns a
    // portfolio into a form, which is the feeling this product exists to
    // remove.
    firstRunLead: "Let's start with your name",
    firstRunSub: 'Three things and your portfolio is real. The preview on the right is already yours — it just has nothing to show yet.',
    stepName: 'Your name',
    stepNameWhy: 'Without it the page has nothing to put at the top.',
    stepPhoto: 'Your photo or logo',
    stepPhotoWhy: 'The first thing anyone looks at.',
    stepPiece: 'Your first piece',
    stepPieceWhy: 'Three to six pieces is a portfolio. One is a start.',
    stepDone: 'done',
    stepNotReady: 'Not ready yet — your portfolio works without one.',
    emptySlot: 'An empty slot, waiting for a piece',
  ...
  ar: {
    ...
    copy: 'نسخ',
    copied: 'تم النسخ',
    // ── الانطلاقة الأولى — المخطط §5.4 ──────────────────────────────
    // لا أوامر موجّهة لشخص: أسماء وأفعال مصدرية فقط.
    firstRunLead: 'لنبدأ بالاسم',
    firstRunSub: 'ثلاثة أشياء ويصبح معرضك حقيقيًا. المعاينة بجانبك معرضك فعلًا — لا شيء فيها لتعرضه بعد.',
    stepName: 'اسمك',
    stepNameWhy: 'بدونه لا تجد الصفحة ما تضعه في أعلاها.',
    stepPhoto: 'صورتك أو شعارك',
    stepPhotoWhy: 'أول ما تقع عليه العين.',
    stepPiece: 'أول عمل',
    stepPieceWhy: 'من ثلاثة إلى ستة أعمال معرض. وواحد بداية.',
    stepDone: 'تم',
    stepNotReady: 'ليست جاهزة بعد — معرضك يعمل بدونها.',
    emptySlot: 'مكان فارغ، بانتظار عمل',
