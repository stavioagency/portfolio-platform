...
export const termsContent = {
  ar: {
    ...
    sections: [
      ...
      {
        h: 'حدود الخدمة',
        // Latin numerals in both locales — see HANDOFF §1. This was the one
        // Arabic-Indic numeral left in the product.
        p: 'تُقدَّم الخدمة كما هي دون ضمان تشغيل مستمر بنسبة 100٪، خصوصًا في هذه المرحلة المبكرة من المنتج.',
      },
      {
        h: 'الملكية الفكرية',
