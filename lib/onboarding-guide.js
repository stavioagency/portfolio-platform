...
export const GUIDE_STEPS = [
  {
    id: 'publish',
    tab: 'profile',
    title: { ar: 'الاسم والمسمّى', en: 'Add your name and title' },
    why: {
    ...
    how: {
      ar: [
        'من «الملف الشخصي».',
        'الاسم بالعربية والإنجليزية — الحقلان منفصلان.',
        'المسمّى: «مصمم جرافيك»، «مصوّر»، «مخرج فيديو».',
        'ثم «حفظ».',
      ],
      en: [
        'Open Profile.',
    ...
    tip: {
      ar: 'اللغتان معًا أفضل. الزائر من الخليج غالبًا يقرأ بالعربية، والعميل الأجنبي بالإنجليزية — والحقل الفارغ يظهر فارغًا.',
  ...
  },
  {
    id: 'photo',
    tab: 'profile',
    title: { ar: 'الصورة أو الشعار', en: 'Add your photo or logo' },
    why: {
    ...
    how: {
      ar: [
        'في «الملف الشخصي»، دائرة الصورة.',
        'صورة واضحة للوجه، أو الشعار في حالة العمل باسم علامة.',
        'قصّ الصورة داخل الدائرة ثم الحفظ.',
      ],
      en: [
  ...
  },
  {
    id: 'bio',
    tab: 'profile',
    title: { ar: 'نبذة قصيرة', en: 'Write a short bio' },
    why: {
    ...
    how: {
      ar: [
        ...
        'سطران إلى ثلاثة: ماذا تصمّم، ولمن.',
  ...
  },
  {
    id: 'project',
    tab: 'projects',
    title: { ar: 'أول مشروع', en: 'Add your first project' },
    why: {
    ...
    how: {
      ar: [
        'من «المشاريع» ثم «إضافة مشروع».',
        'عنوان، ثم صورة الغلاف — أقوى صورة لديك.',
        'بقية الصور داخل المشروع تُعرض كشرائح.',
        'سطر عن المشروع: العميل، السنة، الدور فيه.',
      ],
      en: [
  ...
  },
  {
    id: 'links',
    tab: 'links',
    title: { ar: 'روابط التواصل', en: 'Add your contact links' },
    why: {
    ...
    how: {
      ar: [
        'من «الروابط».',
        'واتساب أولًا — أسرع طريقة يتواصل بها العميل في السعودية.',
        'إنستقرام أو بيهانس، إن كان العمل معروضًا هناك.',
      ],
      en: [
        'Open Links.',
    ...
    tip: {
      ar: 'رقم الواتساب بصيغة +966… يتحوّل تلقائيًا إلى رابط محادثة مباشر.',
  ...
  },
  {
    id: 'theme',
    tab: 'appearance',
    title: { ar: 'مظهر الموقع', en: 'Choose how it looks' },
    why: {
    ...
    how: {
      ar: [
        'من «المظهر».',
        'أحد الأنماط الجاهزة كنقطة بداية.',
        'اللون المميّز قابل للتعديل ليطابق الهوية.',
  ...
  },
  {
    id: 'domain',
    tab: 'domains',
    title: { ar: 'ربط نطاقك الخاص', en: 'Connect your own domain' },
    why: {
    ...
    how: {
      ar: [
        ...
        'من «مساحة العمل»، إضافة النطاق.',
        'نسخ سجل DNS المعروض وإضافته عند مزوّد النطاق.',
        'ثم «التحقّق». قد يستغرق الأمر حتى ساعة.',
      ],
      en: [
